...
class MyAdvertisings extends Page
{

    public static function render($request){

        $registerForm = View::render("pages/my-advertisings/register-form");
        $editForm = View::render("pages/my-advertisings/edit-form");

        $content = View::render("pages/my-advertisings/index", [
            "registerForm" => $registerForm,
            "editForm" => $editForm
        ]);
        

        return parent::renderPage("Meus Anúncios", $content);
    }
